...
public class data5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                applovinADS.createRewardedAd(data5.this, new applovinADS.Adfinished() {
                    @Override
                    public void onADfinished() {
                        Intent intent = new Intent(data5.this,data6.class);
